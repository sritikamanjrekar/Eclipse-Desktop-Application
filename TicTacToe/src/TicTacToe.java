...
public class TicTacToe implements ActionListener {
	...
	boolean player1_turn;//true if player 1 turns and vice versa
	...
	public void actionPerformed(ActionEvent e) {
		...
		//run 9 times whenever a button is click
		for(int i=0;i<9;i++) {
	...
	//check if any player is currently won or not
	public void check() {
	...
	//x wins
	//int a b c buttons combination which will turn green
